 ...
 */
@ApiModel(description = "Odata response wrapper for a Power BI Report collection")
...
public class ODataResponseListReport {
  ...
  **/
  ...
  public ODataResponseListReport addValueItem(Report valueItem) {
    if (this.value == null) {
      this.value = new ArrayList<Report>();
    }
   ...
   * @return value
  **/
  @ApiModelProperty(value = "The report collection")
